...
\begin{figure}[ht]
\centering
\figuraplaceholder[\textwidth]{figures/evolucion-arquitecturas.png}{Evolución de las arquitecturas de visión por computador para clasificación de imágenes, desde las CNN secuenciales (VGG) y residuales (ResNet) hasta las densas (DenseNet), las modernas (ConvNeXt) y los transformers de visión (Swin).}
